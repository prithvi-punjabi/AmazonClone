...
body {font-family: 'Amazon Ember', sans-serif; margin:0;width:auto;}
...
<table class="but">
	<tr>
	<td><button onclick="window.location.href='clear1.php'" class="button1">Clear Cart</button>
	<td><button onclick="window.location.href='checkout1.php'" class="button"><span>Proceed to Checkout</span></button>
	</tr>
</table>
