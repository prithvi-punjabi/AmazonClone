...
<!--   <div class="rating"
  ...
  <a style="text-decoration:none;font-family:'Amazon Ember';" href="#"> 73 cutomer reviews</a> |<a style="text-decoration:none;" href="#">24 answered questions</a>
   <hr>
	 <br>
<div class="price">
  <table style="font-family: 'Amazon Ember';">
    <tr>
    ...
    <td>	<font color="gray" ><strike>₹ 1699.00</strike> </font></td>
      ...
      <tr >
        <td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPrice:</td>
          <td colspan="1" style="color:red">Rs. 699</td>
        </tr>
      <tr>
      ...
      <tr>
        <td>Inclusive of all taxes</td>
	      ...
	      <tr>
			...
			<br>
      <hr>
			<p style="font-size:18px;"><font color="green;">In stock</p></font>
			<p>Sold by <a>LLI Fashion Company </a>(4.4 out of 5 | 6,652 ratings) and<a> Fulfilled by Amazon.</a></p>
      <p><a>2 offers </a>from<font> ₹699.00</font></p>
      <ul style="font-family: 'Amazon Ember';">
   ...
   <div  class="cart">
	 ...
	 <form method=post action="dress.php?id=<?php echo $user1 ?>">
       <input type="image" src="a2c.png" name="cart2" Style="margin-left: 12px;width:168px;height:28px;margin-top:1em;" value="add to cart">
       <br>
       <img style="margin-left: 12px;width:170px;height:30px;margin-top:1em;" src="buy.png">
       <hr>
       <img src="" ><a Style="font-size:11px;margin-left:46px;" href="#">Select drop location</a>
			 <br><br>
	</form>
		<?php
	  ...
	  <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
	    <footer>
	      ...
	      <div class="middle">
	        <div class="center">
	          <ul>
	            <li><h3 class="first">Get to Know Us</h3></li>
