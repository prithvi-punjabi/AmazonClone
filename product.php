...
<style>
body {font-family: 'Amazon Ember'; margin:0;width:auto;}
  ...
  <td><a >Details</a></td>
   ...
   <div  class="cart">
	...
	<form method=post action="product.php?id=<?php echo $user ?>">
       <input type="image" src="a2c.png" name="cart1" Style="margin-left: 12px;width:168px;height:28px;margin-top:1em;" value="add to cart">
       <br>
